...
public class DisabledVeteransPage extends Page {
	...
	//Locators added for elements on Exemption screen
	...
	@FindBy(xpath = "//span[text() = 'APN']//parent::div//following-sibling::div//span//slot//slot//force-lookup//div//force-hoverable-link//div//a")
	...
	/*public void enterExemptionDataWithMandatoryField(Map<String, String> dataMap) throws Exception {
		...
		Adding Veteran details to make the record unique 
		which will allow the script to run multiple times without any issues
		enter(nameOfVeteran, dataMap.get("Veteran Name"));
		enter(veteranSSN, dataMap.get("Veteran SSN"));
	...
	/**
	 * Description: This method will click 'Show More Button' on Exemption screen
	 * @param recordId: Exemption Record Id
