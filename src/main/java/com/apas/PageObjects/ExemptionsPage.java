...
public String fetchAssesseeName() {
    ...
    */
	public String fetchActiveAPN() {
		SalesforceAPI objSalesforceAPI = new SalesforceAPI();
		String queryForID = "SELECT Name FROM Parcel__c where Status__c='Active' and PUC_Code_Lookup__r.name in ('01-SINGLE FAMILY RES','02-DUPLEX','03-TRIPLEX','04-FOURPLEX','05-FIVE or MORE UNITS','07-MOBILEHOME','07F-FLOATING HOME','13-STORE & RESIDENCE','89-RESIDENTIAL MISC.','91-MORE THAN 1 DETACHED LIVING UNITS','92-SFR CONVERTED TO 2 UNITS','93-SFR & DUPLEX OR TRIPLEX','94-TWO DUPLEXES','95','96-FOURPLEX PLUS A RESIDENCE DUPLEX OR TRI','97-RESIDENTIAL CONDO','97H-HOTEL CONDO','98-CO-OPERATIVE APARTMENT','96H-FOURPLEX PLUS A RESIDENCE, DUPLEX OR TRI','95-RESIDENTIAL; COMBINATION OF UNIT TYPES','53-SFR, OVER 40 ACRES','52-SFR, 5 TO 40 ACRES','51-SFR, UNDER 5 ACRES','45-AG. PRESERVE, IMPROVED','43-TPZ, IMPROVED') Limit 1";
		HashMap<String, ArrayList<String>> response  = objSalesforceAPI.select(queryForID);
