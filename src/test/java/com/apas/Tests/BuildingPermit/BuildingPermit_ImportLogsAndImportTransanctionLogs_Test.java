...
public class BuildingPermit_ImportLogsAndImportTransanctionLogs_Test extends TestBase {
	...
	public void verify_ImportLogsAndTransactions_BuildingPermitAtherton(String loginUser) throws Exception {
		...
		softAssert.assertEquals(importLogsGridData.size(),10,"SMAB-T431 : Columns count validation on Import Logs Grid");
		softAssert.assertEquals(importLogsGridData.get("Name").get(0),"Building Permit :Atherton Building Permits :" + period,"SMAB-T431 : Validation for column 'Name' on Import Logs Grid");
		softAssert.assertEquals(importLogsGridData.get("File Type").get(0),"Building Permit","SMAB-T431 : Validation for column 'File Type' on Import Logs Grid");
		...
		softAssert.assertEquals(objApasGenericFunctions.getFieldValueFromAPAS("Name"), "Building Permit :Atherton Building Permits :" + period, "SMAB-T431 : 'Name' Field Validation on Import Logs details tab");
		softAssert.assertEquals(objApasGenericFunctions.getFieldValueFromAPAS("File Type"), "Building Permit", "SMAB-T431 : 'File Type' Field Validation on Import Logs details tab");
	...
	public void verify_ImportLogsAndTransactions_BuildingPermitSanMateo(String loginUser) throws Exception {
		...
		softAssert.assertEquals(importTransactionsGridData.size(),8,"SMAB-T430 : Columns count validation on Import Transactions Grid");
		softAssert.assertEquals(importTransactionsGridData.get("Status").get(0),"Imported","SMAB-T430 : Validation for column 'Status' on Import Transactions Grid");
		softAssert.assertEquals(importTransactionsGridData.get("E-File Import Log").get(0),"Building Permit :San Mateo Building permits :" + period,"SMAB-T430 : Validation for column 'Name' on Import Transactions Grid");
		...
		softAssert.assertEquals(objApasGenericFunctions.getFieldValueFromAPAS("Name"), importTransactionsGridData.get("Name").get(0), "SMAB-T431 : 'Name' Field Validation on Import Transaction details tab");
		softAssert.assertEquals(objApasGenericFunctions.getFieldValueFromAPAS("E-File Import Log"), "Building Permit :San Mateo Building permits :" + period, "SMAB-T431 : 'E-File Import Log' Field Validation on Import Transactions details tab");
		softAssert.assertEquals(objApasGenericFunctions.getFieldValueFromAPAS("Status"), "Imported", "SMAB-T431 : 'Status' Field Validation on Import Transactions details tab");
		softAssert.assertTrue(objPage.verifyElementVisible(objEfileImportTransactionsPage.transactionTrailTab), "SMAB-T431 : Validation for existence of Transactions Trails tab on Import Transactions Screen");
