...
public class BuildingPermitImportTest extends TestBase {
	 ...
	 **/
	@Test(description = "SMAB-T361,SMAB-T358: Reverting the error records in building permit import", dataProvider = "loginUsers", groups = {"smoke","regression"}, alwaysRun = true)
	 ...
	 **/
	@Test(description = "SMAB-T364: Retrying the error records in building permit import", dataProvider = "loginUsers", groups = {"smoke","regression"}, alwaysRun = true)
