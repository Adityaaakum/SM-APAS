package com.apas.Tests.ParceleEventLibrary;
...
public class Parcel_Management_Parcel_Event_Library_Tests extends TestBase implements testdata, modules, users {
	...
	@Test(description = "SMAB-T3698,SMAB-T3699,SMAB-T23708:Verify audit trail update with Parcel Transfer Allowed value", dataProvider = "loginSystemAdmin", dataProviderClass = DataProviders.class, groups = {
			"Regression", "ParcelManagement", "ParcelEventLibrary" })
