	...
	public void WorkItem_Consolidation(String loginUser) throws Exception {
		...
		String Workitem = "WI-00000691";
		 ...
		 HashMap<String, ArrayList<String>> response =salesforceAPI.select(queryAPNValue); 
		  ...
		  PrimaryWorkitem =objParcelsPage.createWorkItem(hashMapmanualWorkItemData); Thread.sleep(2000);
		  ...
		  objWorkItemHomePage.clickElementOnVisiblity("//label[text()='Select Primary']/following-sibling::div//span[contains(@title,'"+ PrimaryWorkitem + "')]");///
		  ...
		  Thread.sleep(2000);
		  WebElement element = driver.findElement(By.xpath("//div[contains(@class,'windowViewMode-normal') or contains(@class,'windowViewMode-maximized')]//span[text()='"+secondaryWorkitem + "']")); 
		  objWorkItemHomePage.scrollToElement(element);
