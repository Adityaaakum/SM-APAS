...
public class WorkItems_SecurityAndSharing_Tests extends TestBase implements testdata, modules, users {
	...
	public void WorkItems_SharingAndSecurity_ButtonPresent_WIHomePage_SupervisorUser(String loginUser) throws Exception {
		...
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.reassignButton)), "SMAB-T2636: Validate that reassignButton is visible in Needs My Approval  tab");
		...
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.PutOnHoldButton)), "SMAB-T2636: Validate that PutOnHoldButton is visible in Needs My Approval  tab");
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.assignLevel2Approver)), "SMAB-T2636: Validate that assignLevel2Approver is visible in Needs My Approval  tab");
		...
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.returnToPool)), "SMAB-T2636: Validate that returnToPool button is visible in InProgress tab");
		//softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.PutOnHoldButton)), "SMAB-T2033: Validate that PutOnHoldButton button is visible in InProgress tab");
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.ConsolidateButton)), "SMAB-T2636: Validate that ConsolidateButton button is visible in InProgress tab");
		...
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.markInProgress)), "SMAB-T2636: Validate that mark in progress button is visible in On_Hold tab");

		//Step8: Validate the buttons in SubmittedforApproval tab
		objWorkItemHomePage.Click(objWorkItemHomePage.lnkTABMySubmittedforApproval);
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.WithdrawButton)), "SMAB-T2636: Validate that WithdrawButton is present in SubmittedforApproval tab");

		//Step9: Validate the buttons in StaffInProgress tab
		objWorkItemHomePage.openTab(objWorkItemHomePage.TAB_StaffInProgress);
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.changeWorkPool)), "SMAB-T2636: Validate that changeWorkPool button is present in StaffInProgress tab");
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.changeAssignee)), "SMAB-T2636: Validate that changeAssignee button is present in StaffInProgress tab");

		//Step10: Validate the buttons in StaffOnHold tab
		driver.navigate().refresh();
		objWorkItemHomePage.waitForElementToBeVisible(10,objWorkItemHomePage.lnkTABInProgress);
		objWorkItemHomePage.openTab(objWorkItemHomePage.TAB_StaffOnHold);
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.changeWorkPool)), "SMAB-T2636: Validate that changeWorkPool button is present in Staff on hold tab");
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.changeAssignee)), "SMAB-T2636: Validate that changeAssignee button is present in Staff on hold tab");

		//Step11: Validate the buttons in StaffInPool tab
		driver.navigate().refresh();
		objWorkItemHomePage.waitForElementToBeVisible(10,objWorkItemHomePage.lnkTABInProgress);
		objWorkItemHomePage.openTab(objWorkItemHomePage.TAB_StaffInPool);
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.changeWorkPool)), "SMAB-T2636: Validate that changeWorkPool button is present in StaffInPool tab");
		softAssert.assertTrue(objLoginPage.verifyElementVisible(objWorkItemHomePage.getButtonWithText(objWorkItemHomePage.changeAssignee)), "SMAB-T2636: Validate that changeAssignee button is present in StaffInPool tab");
