...
public class Parcel_Management_CombineMappingAction_Test extends TestBase implements testdata, modules, users {
	...
	public void AParcelManagement_VerifyErrorMessageOnFirstScreenForParcelCombineMappingAction(String loginUser) throws Exception {
	...
	@Test(description = "SMAB-T2356,SMAB-T2358: Verify user is able to overwrite APN generated by system and validate error messages related to ownership record during Combine process", dataProvider = "loginMappingUser", dataProviderClass = DataProviders.class, groups = {
			"Regression","ParcelManagement" })
	public void DParcelManagement_VerifyParcelOverwriteForCombineMappingAction(String loginUser) throws Exception {
	...
	@Test(description = "SMAB-T2357,SMAB-T2373,SMAB-T2376,SMAB-T2443,SMAB-2567,SMAB-2812: Verify user is able to combine as many number of parcels into one and attributes are inherited in the child parcel from the parent parcel", dataProvider = "loginMappingUser", dataProviderClass = DataProviders.class, groups = {
			"Regression","ParcelManagement" })
	public void CParcelManagement_VerifyParcelCombineMappingAction(String loginUser) throws Exception {
	...
	@Test(description = "SMAB-T2884, SMAB-T2896,SMAB-T3669,SMAB-T2956,SMAB-T2881: Verify generation of Interim Parcels for Combine Mapping Action and validation around it", dataProvider = "loginMappingUser", dataProviderClass = DataProviders.class, groups = {
			"Regression","ParcelManagement" })
	public void BParcelManagement_VerifyGenerationOfInterimParcelForCombineMappingAction(String loginUser) throws Exception {
