...
public class DisabledVeteran_ExemptionAmountCalculation_Test extends TestBase{
	 ...
	 **/
	@Test(description = "SMAB-T574, SMAB-T612: Verify Basic & Net Exemption Amount for each 'Active' Value Adjustemnt", dataProvider = "loginExemptionSupportStaff",dataProviderClass = DataProviders.class, groups = {"smoke", "regression","DisabledVeteranExemption" })
		...
		//Step5: Calculate and verify Total number of Value Adjustments in an Exemption		
		 ...
		 softAssert.assertEquals(noOfVAs, 3, "Verify Number of Value Adjustments");	  
		  ...
		  for (int VARowNo = 0; VARowNo<noOfVAs; VARowNo++) { 			 				  
			...
			float actualNetExemptionAmount = objApasGenericFunctions.convertToFloat(objValueAdjustmentPage.netExemptionAmountCalculatedValueLabel.getText());			 			  
  ...
  @Test(description = "SMAB-T573, SMAB-T512, SMAB-T475: Verify Low Income Exemption Amount for each 'Active' Value Adjustemnt", dataProvider = "loginExemptionSupportStaff",dataProviderClass = DataProviders.class, groups = {"regression","DisabledVeteranExemption" })
  	public void DisabledVeteran_verifyLowIncomeExemptionAmount(String loginUser) throws Exception {
		...
		Float actualExemptionAmount = objApasGenericFunctions.convertToFloat(objValueAdjustmentPage.exemptionAmountCalculatedValueLabel.getText());
