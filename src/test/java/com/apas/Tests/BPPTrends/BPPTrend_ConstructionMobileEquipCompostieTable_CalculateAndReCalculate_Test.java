...
public class BPPTrend_ConstructionMobileEquipCompostieTable_CalculateAndReCalculate_Test extends TestBase {
	...
	*//**
	 ...
	 *//*
	@Test(description = "SMAB-T239,SMAB-T240,SMAB-T241,SMAB-T269,SMAB-T190,SMAB-T194,SMAB-T198,SMAB-T442: Performing validation on CONSTRUCTION MOBILE EQUIP COMPOSITE FACTORS before and after calculation", groups = {"smoke,regression,BppTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 0, enabled = true)
	public void verify_BppTrend_AConstructionMobileEquipCompostieTable_CalculateAndCompare(String loginUser) throws Exception {					
	...
	*//**
	 ...
	 *//*
	@Test(description = "SMAB-T195,SMAB-T196,SMAB-T442: Performing validation on CONSTRUCTION MOBILE EQUIP COMPOSITE FACTORS before and after calculation", groups = {"smoke,regression,BppTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 1, enabled = true)
