...
public class BpTrend_CalculateWithMissing_IndexAndFactorSettings extends TestBase {
	...
	public void verify_BppTrend_CompositeFactors_CalculateWithCalculationVariablesMissing(String loginUser) throws Exception {					
		try {
			...
			ExtentTestManager.getTest().log(LogStatus.INFO, "** Creating entries for BPP Composite Factor Settings **");
			objBppTrnPg.waitForElementToBeVisible(objBppTrnPg.moreTabRightSection, 20);
			objBppTrnPg.waitForElementToBeClickable(objBppTrnPg.moreTabRightSection, 10);
			objBppTrnPg.clickAction(objBppTrnPg.moreTabRightSection);
			
			objBppTrnPg.waitForElementToBeVisible(objBppTrnPg.bppCompositeFactorOption, 10);
			objBppTrnPg.waitForElementToBeClickable(objBppTrnPg.bppCompositeFactorOption, 10);
			objBppTrnPg.clickAction(objBppTrnPg.bppCompositeFactorOption);

			objBppTrnPg.createBppCompositeFactorSetting("Commercial", "10");
			objBppTrnPg.createBppCompositeFactorSetting("Industrial", "9");
			objBppTrnPg.createBppCompositeFactorSetting("Agricultural", "11");
			objBppTrnPg.createBppCompositeFactorSetting("Construction", "10");
			...
			//Step19: Delete the dummy tend setup created for error messages validation
