...
public class BPPTrend_CommercialCompostieTable_CalculateAndReCalculate_Test extends TestBase {
	 ...
	 */
	@Test(description = "SMAB-T170,SMAB-T162,SMAB-T165,SMAB-T190,SMAB-T198: Performing validation on COMMERCIAL COMPOSITE FACTORS before and after calculation", groups = {"Smoke","Regression","BPPTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class)
	public void BppTrend_CommercialCompositeFactors_CalculateAndCompare(String loginUser) throws Exception {
		...
		objBppTrend.updateMinimumEquipmentIndexFactorValue("Commercial", "10", rollYear);
		...
		softAssert.assertEquals(FileUtils.compareHashMaps(actualImportedRowTable,dataMapFromExcel),"","SMAB-T162, SMAB-T165: Data Comparison validation for Imported Row Table");
		...
		softAssert.assertEquals(statusInBppTrendSetup, "Calculated", "SMAB-T170: Verify Table status on Bpp Trend Setup page post calculation");
	 ...
	 */
	@Test(description = "SMAB-T173,SMAB-T195,SMAB-T196: Performing validation on COMMERCIAL COMPOSITE FACTORS before and after calculation", groups = {"Regression","BPPTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class)
	public void BppTrend_CommercialCompositeFactors_ReCalculateAndCompare(String loginUser) throws Exception {
		...
		//Resetting the minimum equipment index factor value to default value
		objBppTrend.updateMinimumEquipmentIndexFactorValue("Commercial", "50", rollYear);
		...
		softAssert.assertTrue(objBppTrend.isTableDataVisible(tableName, 60), "SMAB-T195: User successfully triggered ReCalculation for '"+ tableName +" 'table");
