...
public class BPPTrend_CommercialCompostieTable_CalculateAndReCalculate_Test extends TestBase {
	 ...
	 */
	@Test(description = "SMAB-T162,SMAB-T165,SMAB-T190,SMAB-T198: Performing validation on COMMERCIAL COMPOSITE FACTORS before and after calculation", groups = {"smoke","regression","BPPTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class)
	public void BppTrend_CommercialCompositeFactors_CalculateAndCompare(String loginUser) throws Exception {
		...
		softAssert.assertEquals(statusInBppTrendSetup, "Calculated", "Table status on Bpp Trend Setup page post calculation");
