...
public class BPPTrend_ConstructionCompostieTable_CalculateAndReCalculate_Test extends TestBase {
	 ...
	 */
	@Test(description = "SMAB-T253,SMAB-T254,SMAB-T255,SMAB-T190,SMAB-T194,SMAB-T198,SMAB-T442: Performing validation on CONSTRUCTION COMPOSITE FACTORS before and after calculation", groups = {"smoke","regression","BPPTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class)
	public void verify_BppTrend_ConstructionCompostieTable_CalculateAndCompare(String loginUser) throws Exception {					
		...
		objBppTrnPg.updateMinimumEquipmentIndexFactorValue("Construction", CONFIG.getProperty("minEqipFactorConstructionDefaultValue"), rollYear);
	 ...
	 */
	@Test(description = "SMAB-T195,SMAB-T196,SMAB-T442: Performing validation on CONSTRUCTION COMPOSITE FACTORS before and after calculation", groups = {"smoke","regression","BPPTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class)
	public void verify_BppTrend_ConstructionCompostieTable_ReCalculateAndCompare(String loginUser) throws Exception {					
		...
		objBppTrnPg.updateMinimumEquipmentIndexFactorValue("Construction", CONFIG.getProperty("minEqipFactorUpdatedValue"), rollYear);
		...
		objBppTrnPg.updateTrendSettingInExcel(fileName, "Construction", CONFIG.getProperty("minEqipFactorUpdatedValue"));
		Map<String, List<Object>> dataMapFromExcel = objBppTrnPg.retrieveDataFromExcelForGivenTable(fileName, tableName);
