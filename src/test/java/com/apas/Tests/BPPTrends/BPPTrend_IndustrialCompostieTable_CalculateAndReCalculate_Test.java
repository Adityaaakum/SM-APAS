...
public class BPPTrend_IndustrialCompostieTable_CalculateAndReCalculate_Test extends TestBase {
	...
	*//**
	 ...
	 *//*
	@Test(description = "SMAB-T166,SMAB-T190,SMAB-T194,SMAB-T198,SMAB-T442: Performing validation on INDUSTRIAL COMPOSITE FACTORS before and after calculation", groups = {"smoke,regression,BppTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 0, enabled = true)
	...
	*//**
	 ...
	 *//*
	@Test(description = "SMAB-T302,SMAB-T195,SMAB-T196,SMAB-T442: Performing validation on INDUSTRIAL COMPOSITE FACTORS before and after calculation", groups = {"smoke,regression,BppTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 1, enabled = true)
