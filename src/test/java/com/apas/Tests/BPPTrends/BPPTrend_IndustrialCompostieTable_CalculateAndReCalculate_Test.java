...
public class BPPTrend_IndustrialCompostieTable_CalculateAndReCalculate_Test extends TestBase {
	...
	public void BppTrend_IndustrialCompositeFactors_CalculateAndCompare(String loginUser) throws Exception {
		...
		objBppTrend.updateMinimumEquipmentIndexFactorValue("Industrial", "9", rollYear);
		...
		softAssert.assertTrue(objBppTrend.isTableDataVisible(tableName, 30), "SMAB-T190,SMAB-T194: User successfully triggered calculation for '"+ tableName +" 'table");
		...
		HashMap<String, ArrayList<String>> dataMapFromExcel = ExcelUtils.getExcelSheetData(fileName, 1);
		...
		softAssert.assertEquals(FileUtils.compareHashMaps(actualImportedRowTable,dataMapFromExcel),"","SMAB-T166: Data Comparison validation for Imported Row Table");
	...
	public void BppTrend_IndustrialCompositeFactors_ReCalculateAndCompare(String loginUser) throws Exception {
		...
		//Resetting the minimum equipment index factor value to default value
		objBppTrend.updateMinimumEquipmentIndexFactorValue("Industrial", "50", rollYear);
