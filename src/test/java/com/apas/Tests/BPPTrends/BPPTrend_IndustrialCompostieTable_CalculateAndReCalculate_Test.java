...
public class BPPTrend_IndustrialCompostieTable_CalculateAndReCalculate_Test extends TestBase {
	...
	public void BppTrend_IndustrialCompositeFactors_CalculateAndCompare(String loginUser) throws Exception {
		...
		objBppTrnPg.updateMinimumEquipmentIndexFactorValue("Industrial", CONFIG.getProperty("minEqipFactorIndustrialDefaultValue"), rollYear);
	 ...
	 */
	@Test(description = "SMAB-T302,SMAB-T195,SMAB-T196,SMAB-T442,SMAB-T164: Performing validation on INDUSTRIAL COMPOSITE FACTORS before and after calculation", groups = {"regression","BPPTrend"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class)
	public void BppTrend_IndustrialCompositeFactors_ReCalculateAndCompare(String loginUser) throws Exception {
		...
		objBppTrnPg.updateMinimumEquipmentIndexFactorValue("Industrial", CONFIG.getProperty("minEqipFactorUpdatedValue"), rollYear);
		...
		objBppTrnPg.updateTrendSettingInExcel("Industrial", CONFIG.getProperty("minEqipFactorUpdatedValue"));
		Map<String, List<Object>> dataMapFromExcel = objBppTrnPg.retrieveDataFromExcelForGivenTable(fileName, tableName);
