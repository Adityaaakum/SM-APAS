...
public class BPP_FileNetIntegration_Test extends TestBase {
	...
	@Test(description = "SMAB-T4219: Verify filenet documents on property record page", dataProvider = "BPPAdminAndPrincipalAndAppraisalSupport", dataProviderClass = DataProviders.class, enabled = true, groups = {
