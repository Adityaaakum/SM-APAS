...
public class BppTrend_CalculateAndSubmitForApproval_Test extends TestBase {
	...
	@Test(description = "SMAB-T190: Perform data calculation for factors tables individually", groups = {"smoke","regression","MON"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 5, enabled = true)
	...
	@Test(description = "SMAB-T195: Perform data calculation for factors tables individually", groups = {"smoke","regression","MON"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 6, enabled = true)
	...
	@Test(description = "SMAB-T253: Perform calculation for Construction Composite Factors table", groups = {"smoke","regression","MON"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 2, enabled = true)
	...
	@Test(description = "SMAB-T239: Perform calculation for Construction Mobile Equipment Composite Factors tables", groups = {"smoke","regression","MON"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 1, enabled = true)
	public void verifyBppTrendCalculateConstMobileEquipFactors(String loginUser) throws Exception {
		...
		//Step4: Validating presence of CalculateAll button at page level
		boolean	isCalculateAllBtnDisplayed = objBppTrnPg.isCalculateAllBtnVisible(30);
		...
		//Step6: Validating presence of calculate button for given tables individually
		boolean isCalculateBtnDisplayed = objBppTrnPg.isCalculateBtnVisible(30, tableName);
		...
		//Step12: Validating presence of ReCalculate & Submit For Approval buttons at table level on clicking calculate button
		boolean isReCalculateBtnDisplayed = objBppTrnPg.isReCalculateBtnVisible(30, tableName);
		...
		//Step13: Validating Submit All For Approval button is visible on performing calculation for last factor table
		...
		//Step14: Validating absence of Calculate all button on performing calculation for last composite factor table
		isCalculateAllBtnDisplayed = objBppTrnPg.isCalculateAllBtnVisible(5);
		softAssert.assertTrue(isCalculateAllBtnDisplayed, "SMAB-T239: CalcuateAll button is visible");
	...
	@Test(description = "SMAB-T277, SMAB-T577: Perform calculation for BPP Prop 13 table", groups = {"smoke","regression","MON"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 0, enabled = true)
	public void verifyBppTrendCalculateProp13(String loginUser) throws Exception {
		...
		//Step4: Validating presence of CalculateAll button at page level before
		boolean	isCalculateAllBtnDisplayed = objBppTrnPg.isCalculateAllBtnVisible(30);
		...
		//Step5: Clicking on the BPP Prop 13 table
		String tableName = "BPP Prop 13 Factors";
		objBppTrnPg.clickOnTableOnBppTrendPage(tableName, true);

		//Step6: Validating presence of calculate button for given table
		...
		//Step7: Enter updated value CPI Factor text-box
		...
		//Step10: Retrieve & Assert message displayed above table on clicking calculate button
		...
		//Step11: Retrieve and collect grid CPI Factor data for given roll year in a list
		List<String> gridDataWithFirstCpiFactor = objBppTrnPg.getTextOfMultipleElementsFromProp13Table();
		
		//Step12: Validating presence of ReCalculate button at table level on clicking calculate button
		...
		//Step13: Enter updated value CPI Factor text-box
		...
		//Step14: Clicking on Recalculate button to re-initiate calculation
		ExtentTestManager.getTest().log(LogStatus.INFO, "Clicking 'ReCalculate' Button");
		objBppTrnPg.clickReCalculateBtn("BPP Prop 13 Factors");
		objBppTrnPg.Click(objBppTrnPg.waitForElementToBeClickable(objBppTrnPg.confirmBtnInPopUp));
		
		//Step15: Retrieve & Assert message displayed above table on clicking Recalculate button
		...
		//Step16: Retrieve and collect grid CPI Factor data for given roll year in a list
		List<String> gridDataWithSecondCpiFactor = objBppTrnPg.getTextOfMultipleElementsFromProp13Table();

		//Step17: Checking whether CPI Factor values have updated on UI when calculation done with updated cPI factor value
		...
		//Step18: Retrieving roll year and year acquired values to check roll year values are 1 year greater than acquired year values
	...
	@Test(description = "SMAB-T191,SMAB-T241,SMAB-T255: Perform calculation for all factor tables in one go", groups = {"smoke","regression","MON"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 3, enabled = true)
	...
	@Test(description = "SMAB-T442: Sumbit calculations for approval for all factor tables in one go",groups = {"smoke,regression"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 4, enabled = true)
