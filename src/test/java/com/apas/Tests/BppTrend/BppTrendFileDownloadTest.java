...
public class BppTrendFileDownloadTest extends TestBase {
	...
	@Test(description = "SMAB-T303: Verifying download functionality for excel and PDF files", groups = {"smoke,regression","BPPTrends"}, dataProvider = "loginPrincipalUser", dataProviderClass = DataProviders.class, priority = 0, enabled = true)
	...
	@Test(description = "SMAB-T206: Verifying download functionality for PDF files", groups = {"smoke,regression","BPPTrends"}, dataProvider = "loginBusinessAndPrincipalUsers", dataProviderClass = DataProviders.class, priority = 1, enabled = true)
