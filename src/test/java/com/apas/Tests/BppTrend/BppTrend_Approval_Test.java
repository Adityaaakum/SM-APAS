...
public class BppTrend_Approval_Test extends TestBase {
	...
	@Test(description = "SMAB-T205,SMAB-T304,SMAB-T157: Approve calculations of valuation, composite & prop 13 tables", groups = {"smoke","regression","XYZ"}, dataProvider = "loginPrincipalUser", dataProviderClass = DataProviders.class, priority = 1, enabled = true)
	public void verify_BppTrend_ApprovalForCalculatedCompositeFactorTables(String loginUser) throws Exception {	
	...
	@Test(description = "SMAB-T249: Navigating to all tables post approval with business admin user", groups = {"smoke","regression","XYZ"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 0, enabled = true)
	public void verify_BppTrend_ViewAllApprovedValueTablesByBusinessAdmin(String loginUser) throws Exception {		
		//Resetting the composite factor tables status to Not Calculated
		List<String> compositeFactorTablesToReset = Arrays.asList(CONFIG.getProperty("compositeFactorTablesOnBppSetupPage").split(","));
