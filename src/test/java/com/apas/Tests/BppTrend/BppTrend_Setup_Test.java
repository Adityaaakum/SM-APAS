...
public class BppTrend_Setup_Test  extends TestBase {
	...
	public void verify_BPPTrend_CreateMaxEquipmnetIndexFactor(String loginUser) throws Exception {		
	...
	public void verify_BPPTrend_BusinessAdminIsAbleToSelectAndViewInputFactorTables(String loginUser) throws Exception {		
