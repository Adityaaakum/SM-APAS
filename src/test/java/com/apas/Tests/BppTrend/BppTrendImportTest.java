...
public class BppTrendImportTest extends TestBase {
    ...
    /**
	 ...
	 1. BPP Trend import functionality with business admin and appraisal support user roles
	...
	public void verifyApproveDiscardBuildingPermit(String loginUser) throws Exception {
		...
		//Step3: Uploading the San Mateo Bpp Trend file having error and success records through Efile Intake Import
		ExtentTestManager.getTest().log(LogStatus.INFO, "Uploading the san mateo bpp trend file");
		...
		System.out.println("Reached till here 4");
	 ...
	 **/
	@Test(description = "SMAB-T364: Retrying the error records in building permit import", dataProvider = "loginUsers", groups = {"smoke","regression"}, priority = 0, alwaysRun = true, enabled = false)
