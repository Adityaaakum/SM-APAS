...
public class BppTrend_Prop13Table_CalculateAndReCalculate extends TestBase {
	 ...
	 */
	@Test(description = "SMAB-T190,SMAB-T276,SMAB-T277,SMAB-T278,SMAB-T442,SMAB-T577: Performing validation on PROP 13 FACTORS before and after calculation", groups = {"smoke,regression"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 0, enabled = true)
	public void verifyBppTrend_Prop13Factors_CalculateAndCompare(String loginUser) throws Exception {					
		...
		objSoftAssert.assertEquals(statusInBppTrendSetup, "Calculated", "SMAB-T278: Table status on Bpp Trend Setup page post calculation");
	 ...
	 */
	@Test(description = "SMAB-T302,SMAB-T195,SMAB-T196,SMAB-T442,SMAB-T577: Performing validation on PROP 13 COMPOSITE FACTORS before and after calculation", groups = {"smoke,regression"}, dataProvider = "loginBusinessAdmin", dataProviderClass = DataProviders.class, priority = 1, enabled = true)
	public void verifyBppTrend_IndustrialCompositeFactors_ReCalculateAndCompare(String loginUser) throws Exception {					
		...
		//Step8: Clicking on ReCalculate button
		...
		//Step18: Retrieve and collect grid CPI Factor data for given roll year in a list
		List<String> gridDataWithSecondCpiFactor = objBppTrnPg.getTextOfMultipleElementsFromProp13Table();

		//Step19: Checking whether CPI Factor values have updated on UI when calculation done with updated cPI factor value
		...
		//Step20: Retrieving roll year and year acquired values to check roll year values are 1 year greater than acquired year values
		...
		//Step21: Log out from the application
		objApasGenericFunctions.logout();
			
		//Step22: Assert all the assertions
		softAssert.assertAll();
	}
